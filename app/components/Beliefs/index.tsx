...
const Beliefs = () => {
    ...
    Honesty <span className="text-grey">and dedication drive us forward.</span>
</h3>
<h5 className="text-offwhite pt-2 mb-5 text-center sm:text-start">
    Embracing integrity and hard work to deliver outstanding results and build lasting relationships.
</h5>
...
<h3 className="text-4xl sm:text-6xl font-bold text-black leading-snug mb-5 text-center sm:text-start">
    <span className="text-blue">Turn</span> your great idea into reality.
</h3>
<h5 className="bluish pt-2 mb-5 text-center sm:text-start">
    From concept to completion, we help bring your vision to life with precision and creativity.
</h5>
<div className="text-center sm:text-start">
